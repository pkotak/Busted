...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__services_flickr_service_clients__ = __webpack_require__("../../../../../src/app/services/flickr.service.clients.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__components_widget_widget_list_sortable_directive__ = __webpack_require__("../../../../../src/app/components/widget/widget-list/sortable.directive.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__components_widget_widget_list_order_by_pipe_pipe__ = __webpack_require__("../../../../../src/app/components/widget/widget-list/order-by-pipe.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__components_widget_google_finance_google_stock_buy_google_stock_buy_component__ = __webpack_require__("../../../../../src/app/components/widget/google-finance/google-stock-buy/google-stock-buy.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__components_widget_google_finance_google_stock_edit_google_stock_edit_component__ = __webpack_require__("../../../../../src/app/components/widget/google-finance/google-stock-edit/google-stock-edit.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__components_widget_google_finance_google_stock_list_google_stock_list_component__ = __webpack_require__("../../../../../src/app/components/widget/google-finance/google-stock-list/google-stock-list.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__services_googleFinance_service_client__ = __webpack_require__("../../../../../src/app/services/googleFinance.service.client.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__components_widget_google_finance_google_stock_news_google_stock_news_component__ = __webpack_require__("../../../../../src/app/components/widget/google-finance/google-stock-news/google-stock-news.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__components_user_admin_admin_component__ = __webpack_require__("../../../../../src/app/components/user/admin/admin.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["M" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_36__components_widget_widget_list_sortable_directive__["a" /* SortableDirective */],
            __WEBPACK_IMPORTED_MODULE_37__components_widget_widget_list_order_by_pipe_pipe__["a" /* OrderByPipe */],
            __WEBPACK_IMPORTED_MODULE_38__components_widget_google_finance_google_stock_buy_google_stock_buy_component__["a" /* GoogleStockBuyComponent */],
            __WEBPACK_IMPORTED_MODULE_39__components_widget_google_finance_google_stock_edit_google_stock_edit_component__["a" /* GoogleStockEditComponent */],
            __WEBPACK_IMPORTED_MODULE_40__components_widget_google_finance_google_stock_list_google_stock_list_component__["a" /* GoogleStockListComponent */],
            __WEBPACK_IMPORTED_MODULE_42__components_widget_google_finance_google_stock_news_google_stock_news_component__["a" /* GoogleStockNewsComponent */],
            __WEBPACK_IMPORTED_MODULE_43__components_user_admin_admin_component__["a" /* AdminComponent */]
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_0__angular_platform_browser__["a" /* BrowserModule */], __WEBPACK_IMPORTED_MODULE_7__app_routing__["a" /* routing */], __WEBPACK_IMPORTED_MODULE_5__angular_forms__["a" /* FormsModule */], __WEBPACK_IMPORTED_MODULE_28__angular_http__["b" /* HttpModule */], __WEBPACK_IMPORTED_MODULE_33_ngx_quill_editor__["a" /* QuillEditorModule */]
        ],
        // inject it into any constructors
        providers: [
            __WEBPACK_IMPORTED_MODULE_22__services_user_service_client__["a" /* UserService */],
            __WEBPACK_IMPORTED_MODULE_21__services_website_service_client__["a" /* WebsiteService */],
            ...
            __WEBPACK_IMPORTED_MODULE_27__services_test_service_client__["a" /* TestService */],
            __WEBPACK_IMPORTED_MODULE_30__services_flickr_service_clients__["a" /* FlickrService */],
            ...
            __WEBPACK_IMPORTED_MODULE_41__services_googleFinance_service_client__["a" /* GoogleFinanceServiceClient */],
...
var appRoutes = [
    ...
    { path: 'website', component: __WEBPACK_IMPORTED_MODULE_4__components_website_website_list_website_list_component__["a" /* WebsiteListComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__services_authentication_service_client__["a" /* AuthenticationService */]] },
...
var PageListComponent = (function () {
    // inject route info in constructor
    function PageListComponent(userService, websiteService, pageService, route, sharedService, router, cookieService) {
        this.userService = userService;
        this.websiteService = websiteService;
        this.pageService = pageService;
        this.route = route;
    ...
    //   }
    // }
    PageListComponent.prototype.gotoReport = function () {
...
var PageNewComponent = (function () {
    ...
    PageNewComponent.prototype.create = function (name, duedate) {
        var _this = this;
        if (!name) {
            alert('Please input portfolio name');
        }
...
module.exports = "<nav class=\"navbar navbar-tiffany navbar-fixed-top\">\n  <div class=\"container-fluid\">\n\n    <p class=\"navbar-text pull-left\">\n      <a routerLink=\"/profile\" class=\"white\">\n        <span class=\"glyphicon glyphicon-chevron-left \"></span>\n      </a>\n    </p>\n\n    <!--heading on the nav bar-->\n    <div class=\"navbar-brand pull-left\">\n      <!--<a class=\"thick white nounderline \" href=\"../page/page-list.html\">-->\n      <b class=\"white\">Admin Dashboard</b>\n      <!--</a>-->\n    </div>\n\n    <!--tick mark-->\n\n  </div>\n</nav>\n\n\n\n<div class = \"container-fluid padding paddingleft padding-b\">\n  <table id = \"customers\">\n    <!--<thead>-->\n    <!--<tr>-->\n      <!--<th><input type=\"text\" name=\"email\" [(ngModel)]=\"filter.email\"  placeholder=\"Email\"></th>-->\n      <!--<th><input type=\"text\" name=\"firstName\" [(ngModel)]=\"filter.firstName\" placeholder=\"FirstName\"></th>-->\n      <!--<th><input type=\"text\" name=\"lastName\" [(ngModel)]=\"filter.lastName\" placeholder=\"LastName\"></th>-->\n      <!--<th><input type=\"text\" name=\"role\" [(ngModel)]=\"filter.role\" placeholder=\"Role\"></th>-->\n      <!--<th><input type=\"text\" name=\"status\" [(ngModel)]=\"filter.status\" placeholder=\"Status\"></th>-->\n    <!--</tr>-->\n    <!--</thead>-->\n\n    <thead>\n    <tr>\n      <th>Id</th>\n      <th>&nbsp; Username</th>\n      <th>&nbsp; First Name</th>\n      <th>&nbsp; Last Name</th>\n      <th>&nbsp; Role</th>\n      <th>&nbsp; Status</th>\n      <th>&nbsp; &nbsp; Approve</th>\n      <th>&nbsp; &nbsp; Delete User</th>\n    </tr>\n    </thead>\n\n    <!--<tfoot>-->\n    <!--<tr>-->\n      <!--&lt;!&ndash;<td colspan=\"5\">&ndash;&gt;-->\n        <!--&lt;!&ndash;<label for=\"limit\">Limit: </label><input type=\"number\" name=\"limit\" [(ngModel)]=\"limit\" min=\"1\" [attr.max]=\"[numberOfBooks]\" step=\"1\" placeholder=\"Limit\">&ndash;&gt;-->\n        <!--&lt;!&ndash;<label for=\"page\">Page: </label><input type=\"number\" name=\"page\" [(ngModel)]=\"page\" min=\"1\" [attr.max]=\"[numberOfBooks]\" step=\"1\" placeholder=\"Page\">&ndash;&gt;-->\n      <!--&lt;!&ndash;</td>&ndash;&gt;-->\n    <!--</tr>-->\n    <!--</tfoot>-->\n    <tbody>\n    <tr *ngFor=\"let user of users\" >\n      <td>&nbsp; {{user.id}}</td>\n      <td>&nbsp; {{user.email}}</td>\n      <td>&nbsp; {{user.firstName}}</td>\n      <td>&nbsp; {{user.lastName}}</td>\n      <td>&nbsp; {{user.type}}</td>\n      <td>&nbsp; {{user.isApproved}}</td>\n\n\n      <td align=\"middle\">\n        &nbsp;&nbsp;&nbsp;&nbsp;\n        <a *ngIf=\"(user.isApproved === false )\" (click)=approve(user.id)\n                class=\"glyphicon glyphicon-ok media-middle\" >\n          <!--Approve User-->\n        </a>\n      </td>\n\n      <td align=\"middle\">\n        &nbsp;&nbsp;&nbsp;&nbsp;\n      <a (click)=deleteUser(user.id) class=\"glyphicon glyphicon-remove \" >\n        <!--Delete User-->\n      </a>\n      </td>\n\n    </tr>\n    </tbody>\n  </table>\n</div>\n\n<!--<div class=\"padding padding-b\">-->\n\n  <!--<div *ngFor = \"let user of users\" class=\"container-fluid\">-->\n\n    <!--<ul  class=\"list-group\">-->\n      <!--<li class=\"list-group-item blue \">-->\n\n\n          <!--<b >-->\n            <!--Email: &nbsp;{{ user.username }}   &nbsp;&nbsp;&nbsp;   Full&nbsp;Name:&nbsp;{{user.lastName}}.{{user.firstName}} &nbsp;&nbsp;&nbsp;&nbsp;-->\n            <!--Role: {{user.role}} &nbsp;&nbsp;  &nbsp;&nbsp; &nbsp;-->\n            <!--Phone: {{user.phone}} &nbsp;&nbsp;-->\n            <!--Status:&nbsp;&nbsp;{{user.status}}-->\n          <!--</b>-->\n\n          <!--<button (click)=deleteUser(user.userId) class=\"pull-right btn-danger \" >-->\n            <!--Delete User-->\n          <!--</button>-->\n\n\n          <!--<button *ngIf=\"(user.status === false)\" (click)=approve(user.userId)-->\n                  <!--class=\"pull-right btn-group \" >-->\n            <!--Approve User-->\n          <!--</button>-->\n\n      <!--</li>-->\n    <!--</ul>-->\n\n  <!--</div>-->\n\n<!--</div>-->\n\n<nav class=\"navbar navbar-tiffany navbar-fixed-bottom\">\n  <div class=\"container-fluid\">\n    <b class=\"navbar-text pull-left white\">\n      Busted\n    </b>\n    <p class=\"navbar-text pull-right\">\n      <a routerLink=\"/profile\" class=\"white\">\n        <span class=\"glyphicon glyphicon-user\"></span>\n      </a>\n    </p>\n  </div>\n</nav>\n"
...
var AdminComponent = (function () {
    ...
    AdminComponent.prototype.approve = function (userId) {
        this.userService.approveUser(userId).subscribe(function (status) {
            console.log(status);
...
module.exports = "<nav class=\"navbar navbar-tiffany navbar-fixed-top\" xmlns=\"http://www.w3.org/1999/html\">\r  <div class=\"container-fluid\">\r\r    <div class=\"navbar-brand pull-left\">\r      <b class=\"white\">Busted!</b>\r    </div>\r\r\r\r  </div>\r</nav>\r\r<div class=\"container padding40 \">\r\r  <div class=\"row\">\r\r    <div class=\"col-sm-8 hidden-xs padding padding-b\">\r\r      <!--<h1 >World Finance</h1>-->\r\r      <img src=\"../../../../assets/images/plagiarism.jpg\" class=\"media-middle\" height=\"539\" width=\"520\"/>\r        <!--<h3 >World Finance: Bloomberg Live News</h3>-->\r        <!--<div class=\"videoWrapper\">-->\r          <!--<iframe  class=\"e2e-iframe-trusted-src\" width=\"560\" height=\"315\"-->\r                   <!--src = 'https://www.youtube.com/embed/Ga3maNZ0x0w?autoplay=1&cc_load_policy=1&controls=0' frameborder=\"0\" allowfullscreen>-->\r          <!--</iframe>-->\r          <!--<br/>-->\r          <!--<br/>-->\r        <!--</div>-->\r      <br/>\r\r      <!--<a routerLink=\"/news\">-->\r        <!--<h3>Search Stock News</h3>-->\r        <!--&lt;!&ndash;<span class=\"glyphicon glyphicon-plus \"></span>&ndash;&gt;-->\r      <!--</a>-->\r      <br/>\r      <br/>\r\r      <!--<div class=\"padding\"></div>-->\r      <!--<ul *ngFor = \"let website of websites\"  class=\"list-group \">-->\r        <!--<li class=\"list-group-item blue borderless\">-->\r\r          <!--&lt;!&ndash;<a routerLink=\"/profile/{{ userId }}/website/{{ wid }}/page\">&ndash;&gt;-->\r          <!--{{ website.name }}-->\r          <!--&lt;!&ndash;</a>&ndash;&gt;-->\r\r          <!--<a class=\"pull-right\" >-->\r            <!--<span class=\"glyphicon glyphicon-cog\"></span>-->\r          <!--</a>-->\r        <!--</li>-->\r      <!--</ul>-->\r\r    </div>\r\r    <div class=\"col-sm-4\">\r      <div class=\"container-fluid padding\">\r        <h3 class=\"header superheader \"><I>Busted</I> </h3>\r        <h4 class=\"thick\">Plagiarism Checker</h4>\r        <form (ngSubmit) = \"login()\" #f=\"ngForm\">\r          <input ngModel\r                 placeholder=\"username\"\r                 name=\"username\"\r                 class=\"form-control\"\r                 type=\"text\"\r                 required\r                 #username = \"ngModel\"/>\r\r          <input ngModel\r                 placeholder=\"password\"\r                 name=\"password\"\r                 class=\"form-control\"\r                 type=\"password\"\r                 required\r                 #password=\"ngModel\"/>\r\r          <button class=\"btn btn-primary btn-block form-control\"\r                  type=\"submit\"\r                  [disabled]=\"!f.valid\"\r          >Login</button>\r          <!--(click)=\"login()\"-->\r\r          <button class=\"btn btn-success btn-block form-control\"\r                  routerLink=\"/register\">Register</button>\r\r          <a  href=\"https://webdev-conan-xuan.herokuapp.com/facebook/login\" class=\"btn btn-primary btn-block\">\r            <!--<a  href=\"http://localhost:9000/facebook/login\" class=\"btn btn-primary btn-block\">-->\r            <!--<button class=\"btn btn-primary btn-block\" [routerLink]=\"['/login']\" type=\"button\">-->\r            <span class=\"fa fa-facebook\"></span>\r            Facebook Login\r          </a>\r        </form>\r\r\r\r      </div>\r    </div>\r  </div>\r\r\r\r</div>\r\r<nav class=\"navbar navbar-tiffany navbar-fixed-bottom\">\r  <div class=\"navbar-text pull-left\">\r    <a routerLink=\"\" class=\"white\">\r      <span class=\"glyphicon glyphicon-home gi-1x\"></span>\r    </a>\r\r  </div>\r  <div class=\"container-fluid\">\r    <b class=\"navbar-text pull-right white\">\r        Integrity comes first\r    </b>\r  </div>\r</nav>\r"
...
var LoginComponent = (function () {
    ...
    function LoginComponent(userService, router, sharedService, sanitizer, cookieService) {
        this.userService = userService;
        this.router = router;
        this.sharedService = sharedService;
        this.sanitizer = sanitizer;
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.userService
            ...
            _this.cookieService.set('user', String(data.id));
            _this.router.navigate(['/profile']);
            console.log(_this.cookieService.get('user'));
        }, function (error) {
            console.log(error);
...
var ProfileComponent = (function () {
    // inject route info in constructor
    function ProfileComponent(userService, activatedRoute, sharedService, websiteService, router, sanitizer, cookieService) {
        this.userService = userService;
        this.activatedRoute = activatedRoute;
        this.sharedService = sharedService;
        this.websiteService = websiteService;
    ...
    ProfileComponent.prototype.addclass = function () {
        if (this.user.role === 'STUDENT') {
            alert('Student cannot create classes');
        }
        else if (this.user.role === 'TA') {
...
ProfileComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__services_user_service_client__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_user_service_client__["a" /* UserService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_6__services_shared_service_client__["a" /* SharedService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6__services_shared_service_client__["a" /* SharedService */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3__services_website_service_client__["a" /* WebsiteService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_website_service_client__["a" /* WebsiteService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser__["b" /* DomSanitizer */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_7__angular_platform_browser__["b" /* DomSanitizer */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_8_ngx_cookie_service__["a" /* CookieService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8_ngx_cookie_service__["a" /* CookieService */]) === "function" && _h || Object])
], ProfileComponent);
        ...
        if (!this.role) {
            ...
            this.userService.findUserByUsername(this.username)
                ...
                if (user.username === _this.username) {
                    ...
                    // });
                    _this.userService
                        .register(_this.username, _this.password, _this.role, _this.firstName, _this.lastName)
...
module.exports = "\n<!--Top navbar -->\n<div class=\"container-fluid\">\n  <nav class=\"navbar navbar-tiffany navbar-fixed-top\">\n\n    <!--<div class=\"navbar-text pull-left\">-->\n    <!--<span class=\"glyphicon glyphicon-chevron-left white pull-left\"></span>-->\n    <!--</div>-->\n\n    <div class=\"row\">\n      <div class=\"col-sm-1\">\n        <div class=\"navbar-text pull-left\">\n          <a routerLink=\"/profile\" class=\"white\">\n            <span class=\"glyphicon glyphicon-chevron-left\"></span>\n          </a>\n        </div>\n      </div>\n\n      <div class=\"col-sm-3 hidden-xs\">\n\n        <div class=\"navbar-brand pull-left\">\n          <!--<a href=\"website-new.html\" class=\"white\">-->\n          <b class=\"white\">Course list</b>\n          <!--</a>-->\n        </div>\n\n        <!--<div class=\"navbar-text pull-right\">-->\n          <!--<span class=\"glyphicon glyphicon-plus white \"></span>-->\n        <!--</div>-->\n        <!--</p>-->\n\n      </div>\n\n      <div class=\"col-sm-8\">\n\n        <!--heading on the nav bar-->\n        <div class=\"navbar-brand pull-left\">\n          <div class=\"thick white\">\n            <b>Course Information</b>\n          </div>\n        </div>\n        <!--tick mark-->\n        <div class=\"navbar-text pull-right\">\n          <a (click)=\"update()\" class=\"white\">\n            <span class=\"glyphicon glyphicon-ok \"></span>\n          </a>\n        </div>\n\n      </div>\n\n    </div>\n  </nav>\n</div>\n\n<div class=\"container-fluid\">\n  <div class=\"row\">\n\n    <div class=\"col-sm-4 hidden-xs\">\n\n\n      <div class=\"padding padding\"></div>\n      <label class ='letter-tiffany paddingleft'>Welcom, {{user.firstName}}! &nbsp; &nbsp; Role: {{user.type}}</label>\n\n      <ul *ngFor = \"let course of courses\"  class=\"list-group \">\n        <li class=\"list-group-item blue borderless\">\n\n          <!--<a routerLink=\"/profile/{{ userId }}/website/{{ wid }}/page\">-->\n          <b>  {{ course.semester }}:    {{course.code}}   {{course.name}}  </b>\n          <!--</a>-->\n\n          <!--<a class=\"pull-right\" >-->\n          <!--<span class=\"glyphicon glyphicon-cog\"></span>-->\n          <!--</a>-->\n        </li>\n      </ul>\n\n    </div>\n\n    <div class=\"col-sm-8 padding\">\n      <div class=\"container-fluid\">\n\n        <br/>\n        <!--<b class ='blue'>My competition:&nbsp; {{this.user.competitionName}}</b>-->\n        <!--<br/>-->\n\n\n        <b class ='blue'>Semester</b>\n        <input [(ngModel)]=\"this.course.semester\"\n                class=\"form-control\"\n                type=\"text\"\n                placeholder='Semester'>\n\n        <b class ='blue'>Course Code</b>\n        <textarea [(ngModel)]=\"this.course.code\"\n                  class=\"form-control\"\n                   type=\"text\"\n                   placeholder='Course Name'></textarea>\n\n\n        <b class ='blue'>Course Name</b>\n        <textarea [(ngModel)]=\"this.course.name\"\n                  class=\"form-control\"\n                  type=\"text\"\n                  placeholder='Course Name'></textarea>\n\n\n        <a (click)=goToMyPortfolio()\n           class=\"btn btn-primary btn-block\" >\n          Go to course assignments\n        </a>\n\n        <a *ngIf=\"(user.type !== 'PROFESSOR' )\" (click)=\"joinClass()\"\n           class=\"btn btn-success btn-block\" >\n          Join Course\n        </a>\n\n        <a *ngIf=\"(user.type !== 'PROFESSOR' )\" (click)=\"dropClass()\"\n           class=\"btn btn-warning btn-block\" >\n          Drop Course\n        </a>\n\n\n        <a *ngIf=\"(user.type === 'PROFESSOR' ) || (user.type === 'ADMIN' )\" (click)=\"deleteWebsite()\"\n          class=\"btn btn-danger btn-block\" >\n          Delete (Admin & Professors only)\n        </a>\n\n\n      </div>\n    </div>\n  </div>\n\n</div>\n\n<nav class=\"navbar navbar-tiffany navbar-fixed-bottom\">\n  <div class=\"container-fluid\">\n    <b class=\"navbar-text pull-left white\">\n      Busted\n    </b>\n    <div class=\"navbar-text pull-right\">\n      <a routerLink=\"/profile\" class=\"white\">\n        <span class=\"glyphicon glyphicon-user \"></span>\n      </a>\n    </div>\n  </div>\n</nav>\n"
...
var WebsiteEditComponent = (function () {
    // inject route info in constructor
    function WebsiteEditComponent(websiteService, route, router, activatedRoute, sharedService, userService, cookieService) {
        this.websiteService = websiteService;
        this.route = route;
        this.router = router;
        this.activatedRoute = activatedRoute;
    ...
    WebsiteEditComponent.prototype.joinClass = function () {
        ...
        this.userService.findUserInCourse(this.user.id, this.course.id, this.user.type)
            ...
            if (user.id === _this.user.id) {
                ...
                _this.userService.joinCourse(newCourseRole)
                    .subscribe(function (newuser) {
                    // console.log(status);
                    // this.user = newuser;
                    console.log(_this.user);
                    alert('Welcome to class "' + _this.course.code + _this.course.name + '"');
                    window.location.reload(false); // reload page
                });
            }
        });
    ...
    WebsiteEditComponent.prototype.dropClass = function () {
        ...
        this.userService.findUserInCourse(this.user.id, this.course.id, this.user.type)
            ...
            if (user.id !== _this.user.id) {
                ...
                _this.userService.dropCourse(courseRole)
                    .subscribe(function (newuser) {
                    // console.log(status);
                    // this.user = newuser;
                    console.log(_this.user);
                    alert('You have dropped "' + _this.course.code + _this.course.name + '"');
                    window.location.reload(false); // reload page
                });
            }
        });
...
module.exports = "\n<nav class=\"navbar navbar-tiffany navbar-fixed-top\">\n  <div class=\"container-fluid\">\n\n    <!--heading on the nav bar-->\n    <p class=\"navbar-text pull-left\">\n      <a routerLink=\"/profile\" class=\"white\">\n        <span class=\"glyphicon glyphicon-chevron-left \"></span>\n      </a>\n    </p>\n\n    <div class=\"navbar-brand pull-left\">\n      <b class=\"white\">All Courses</b>\n    </div>\n\n    <!--tick mark-->\n    <div class=\"navbar-brand pull-right\">\n      <a (click) = addclass() class=\"white \">\n        <b>Add course</b>\n        <!--<span class=\"glyphicon glyphicon-plus \"></span>-->\n      </a>\n    </div>\n  </div>\n</nav>\n\n\n<div class=\" container-fluid padding\"></div>\n\n<label class ='letter-tiffany paddingleft'>Welcom, {{user.firstName}}! &nbsp; &nbsp; Role: {{user.type}}</label>\n<br/>\n<!--<label class ='letter-tiffany paddingleft'>My class:&nbsp; {{this.user.classname}}</label>-->\n<br/>\n<!--<label class ='letter-tiffany paddingleft'>My competition:&nbsp; {{this.user.competitionName}}</label>-->\n<!--<br/>-->\n\n\n<div class = \"container-fluid  paddingleft padding-b\">\n  <table id=\"customers\">\n\n    <thead>\n    <tr>\n      <th>&nbsp; Semester</th>\n      <th>&nbsp; Code</th>\n      <th>&nbsp; Name</th>\n      <!--<th>  Go To Course</th>-->\n    </tr>\n    </thead>\n\n    <tbody>\n    <tr *ngFor=\"let course of courses\" routerLink=\"/user/website/{{ course.id }}\">\n      <td>&nbsp; {{course.semester}}</td>\n      <td>&nbsp; {{course.code}}</td>\n      <td>&nbsp; {{course.name}}</td>\n      <!--<td>&nbsp;-->\n        <!--<a class=\"glyphicon glyphicon-chevron-right \" routerLink=\"/user/website/{{ course.id }}\">-->\n        <!--</a>-->\n      <!--</td>-->\n\n\n\n    </tr>\n    </tbody>\n  </table>\n</div>\n\n\n<!--<div *ngFor = \"let website of websites\" class=\"container-fluid \">-->\n  <!--<ul  class=\"list-group\">-->\n    <!--<li class=\"list-group-item blue \">-->\n      <!--<a routerLink=\"/user/website/{{ website._id }}\" class=\"thick\">-->\n      <!--<b >-->\n        <!--Semester: {{ website.name }}    &nbsp;&nbsp; Course: {{website.description}}   &nbsp;&nbsp;Professor: &nbsp;{{ website._user.username}}-->\n      <!--</b>-->\n      <!--</a>-->\n      <!--&lt;!&ndash;<button class=\"pull-right btn-primary \" routerLink=\"/user/website/{{ website._id }}\">&ndash;&gt;-->\n        <!--&lt;!&ndash;Go to my class&ndash;&gt;-->\n      <!--&lt;!&ndash;</button>&ndash;&gt;-->\n\n    <!--</li>-->\n  <!--</ul>-->\n<!--</div>-->\n\n<nav class=\"navbar navbar-tiffany navbar-fixed-bottom\">\n  <div class=\"container-fluid\">\n    <b class=\"navbar-text pull-left white\">\n      Busted\n    </b>\n    <p class=\"navbar-text pull-right\">\n      <a routerLink=\"/profile\" class=\"white\">\n        <span class=\"glyphicon glyphicon-user\"></span>\n      </a>\n    </p>\n  </div>\n</nav>\n\n"
...
var WebsiteListComponent = (function () {
    // inject route info in constructor
    function WebsiteListComponent(websiteService, route, userService, sharedService, router, cookieService) {
        this.websiteService = websiteService;
        this.route = route;
        this.userService = userService;
        this.sharedService = sharedService;
...
var WebsiteNewComponent = (function () {
    // inject route info in constructor
    function WebsiteNewComponent(websiteService, route, router, sharedService, cookieService, userService) {
        this.websiteService = websiteService;
        this.route = route;
        this.router = router;
        this.sharedService = sharedService;
...
WebsiteNewComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_3__services_website_service_client__["a" /* WebsiteService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__services_website_service_client__["a" /* WebsiteService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["a" /* ActivatedRoute */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_router__["b" /* Router */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_5__services_shared_service_client__["a" /* SharedService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__services_shared_service_client__["a" /* SharedService */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_6_ngx_cookie_service__["a" /* CookieService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_6_ngx_cookie_service__["a" /* CookieService */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_2__services_user_service_client__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__services_user_service_client__["a" /* UserService */]) === "function" && _g || Object])
], WebsiteNewComponent);
...
module.exports = "\n<nav class=\"navbar navbar-light2 navbar-fixed-top\">\n  <div class=\"container-fluid\">\n\n    <!--heading on the nav bar-->\n    <div class=\"navbar-text pull-left\">\n      <a routerLink=\"/user/website/{{wid}}/page\" class=\"black\">\n        <span class=\"glyphicon glyphicon-chevron-left \"></span>\n      </a>\n    </div>\n\n    <div class=\"navbar-brand pull-left\">\n      <div class=\"thick\">\n        <b>Assignment: {{this.page.name}}</b>\n      </div>\n    </div>\n\n    <!--tick mark-->\n    <!--<div class=\"navbar-text pull-right\">-->\n      <!--<a routerLink=\"/user/website/{{wid}}/page/{{pid}}/widget/new\"-->\n         <!--class=\"black\">-->\n        <!--<span class=\"glyphicon glyphicon-plus\"></span>-->\n      <!--</a>-->\n    <!--</div>-->\n\n  </div>\n</nav>\n\n\n\n<div class=\"container-fluid padding padding-b \" >\n  <label class ='letter-tiffany paddingleft'>Please make sure submit your assignments before due day. Any late\n  submission will be subjected to 50% grade deduction!</label>\n\n  <div class=\"widget-list paddingleft\" appSortable (newIndexes)=\"reorderWidgets($event)\">\n\n\n        <input type=\"file\" nv-file-select uploader=\"uploader\"/>\n\n        <br/>\n\n\n            <!--Name: <span ng-bind=\"item.file.name\"></span><br/>-->\n        <button ng-click=\"item.upload()\">upload</button>\n\n        <br/>\n        <br/>\n        <label>GitHub Link: </label>\n        <input type = \"text\" #gitUrl>\n\n        <br/>\n        <br/>\n        <button class = 'btn-primary' (click)= submit()>Submit</button>\n\n\n    <div *ngFor = \"let widget of widgets | orderBy\" >\n\n      <div [ngSwitch] = \"widget.type\" >\n\n        <div class=\"jga-widget \">\n\n          <div class=\"jpa-toolbar\">\n            <div>\n              <span class=\"glyphicon glyphicon-menu-hamburger black pull-right\"></span>\n              <a class=\"blue\" routerLink=\"/user/website/{{ wid }}/page/{{pid}}/widget/{{widget._id}}\" >\n\n                <span class=\"glyphicon glyphicon-cog  pull-right\"></span>\n              </a>\n            </div>\n          </div>\n\n          <div *ngSwitchCase=\"'HEADING'\" class=\"padding-b\">\n            <div [ngSwitch]=\"widget.size\">\n              <h1 *ngSwitchCase=\"1\">{{widget.text}}</h1>\n              <h2 *ngSwitchCase=\"2\">{{widget.text}}</h2>\n              <h3 *ngSwitchCase=\"3\">{{widget.text}}</h3>\n              <h4 *ngSwitchCase=\"4\">{{widget.text}}</h4>\n              <h5 *ngSwitchCase=\"5\">{{widget.text}}</h5>\n              <h6 *ngSwitchCase=\"6\">{{widget.text}}</h6>\n            </div>\n          </div>\n\n          <div *ngSwitchCase = \"'IMAGE'\" class=\"padding-b\">\n            Image url: \"{{widget.url}}\"\n            <br/>\n            <img class=\"img-responsive\" [src] = updateImageUrl(widget.url) [style.width] =  \"widget.width\" />\n            <br/>\n          </div>\n\n          <div *ngSwitchCase = \"'HTML'\" [innerHTML]=\"widget.text\" class=\"padding-b\"> </div>\n            <!--<a href=\"{{widget.url}}\" class> <div>{{widget.text}}</div> </a>-->\n\n          <div *ngSwitchCase=\"'INPUT'\" class=\"padding-b\" >\n            Text Input Name: {{widget.name}}\n            <div *ngIf=\"widget.formatted\">\n              <quill-editor [(ngModel)]=\"widget.text\" name=\"text\"></quill-editor>\n            </div>\n            <input *ngIf=\"!widget.formatted && (!widget.rows || widget.rows===1)\"\n                   placeholder=\"{{widget.placeholder}}\" class=\"form-control\"/>\n\n            <textarea *ngIf=\"!widget.formatted && (widget.rows > 1)\"\n                      rows=\"{{widget.rows}}\" placeholder=\"{{widget.placeholder}}\"\n                      class=\"form-control\">{{widget.text}}</textarea>\n          </div>\n\n          <div *ngSwitchCase = \"'YOUTUBE'\" class=\"padding-b\">\n            Video Name: {{widget.name}}\n            <div class=\"videoWrapper\">\n              <iframe  class=\"e2e-iframe-trusted-src\" width=\"560\" height=\"315\"\n                       [src] = updateVideoUrl(widget.url) frameborder=\"0\" allowfullscreen></iframe>\n              <br/>\n            </div>\n          </div>\n\n        </div>\n\n      </div>\n\n    </div>\n  </div>\n</div>\n\n<nav class=\"navbar navbar-light2 navbar-fixed-bottom\">\n  <div class=\"container-fluid\">\n\n    <b class=\"navbar-text pull-left\">\n      Busted\n    </b>\n\n    <div class=\"navbar-text pull-right\">\n      <a routerLink=\"/profile\" class=\"blue\">\n        <span class=\"glyphicon glyphicon-user \"></span>\n      </a>\n    </div>\n  </div>\n</nav>\n"
...
var PageService = (function () {
    ...
    PageService.prototype.createPage = function (courseId, assignment) {
        var url = this.baseUrl + '/api/course/' + courseId + '/assignment';
    ...
    PageService.prototype.findPagesByWebsiteId = function (courseId) {
        var url = this.baseUrl + '/api/course/' + courseId + '/assignment';
...
var UserService = (function () {
    ...
    UserService.prototype.register = function (username, password, role, firstName, lastName) {
    ...
    UserService.prototype.approveUser = function (userId) {
        var url = this.baseUrl + '/api/admin/approve/user/' + userId;
        return this.http.post(url, userId).map(function (res) {
            return res.json();
        });
    };
    ...
    UserService.prototype.joinCourse = function (newCourseRole) {
        var url = this.baseUrl + '/api/user/course/join';
        console.log(newCourseRole);
    ...
    UserService.prototype.dropCourse = function (courseRole) {
        var url = this.baseUrl + '/api/user/course/drop';
        // console.log(courseRole);
    ...
    UserService.prototype.findUserInCourse = function (userId, courseId, role) {
        var myType = {
            // _id: this.userService.newId(),
            type: role
        };
        var url = this.baseUrl + '/api/user/' + userId + '/course/' + courseId;
        console.log(myType);
...
var WebsiteService = (function () {
    ...
    WebsiteService.prototype.findAllClasses = function () {
        var url = this.baseUrl + '/api/allCourses';
        return this.http.get(url).map(function (response) {
            return response.json();
        });
    };
    WebsiteService.prototype.createWebsite = function (userId, course) {
        var url = this.baseUrl + '/api/user/' + userId + '/courses';
    ...
    //
    WebsiteService.prototype.findWebsitesByUserAndRole = function (userId, role) {
        // initiate the array
        // const webs: Website[] = [];
        var url = this.baseUrl + '/api/user/' + userId + role + '/website';
        return this.http.get(url).map(function (response) {
            return response.json();
        });
    };
    // retrieves the website in local websites array whose _id matches the websiteId parameter
    WebsiteService.prototype.findWebsiteById = function (userId, courseId) {
        var url = this.baseUrl + '/api/user/' + userId + '/course/' + courseId;
        return this.http.get(url)
            .map(function (response) {
            return response.json();
    ...
    WebsiteService.prototype.updateWebsite = function (courseId, course) {
        var url = this.baseUrl + '/api/user/course/' + courseId;
        return this.http.post(url, course)
            .map(function (response) {
            return response.json();
        });
    ...
    WebsiteService.prototype.deleteWebsite = function (userId, courseId) {
        var url = this.baseUrl + '/api/user/course/' + courseId;
        return this.http.delete(url)
            .map(function (response) {
            return response.json();
